...
local Utility = {}
local Objects = {}
function Quertz:DraggingEnabled(frame, parent)
...
-- Duplicate 'themes' block removed
-- local themes = {
    SchemeColor = Color3.fromRGB(74, 99, 135),
    Background = Color3.fromRGB(36, 37, 43),
    Header = Color3.fromRGB(28, 29, 34),
...
function Quertz.CreateLib(QuertzName, themeList)
    ...
    local selectedTab 
    QuertzName = QuertzName or "Library"
    table.insert(Quertz, QuertzName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == QuertzName then
            v:Destroy()
        end
    end
    ...
    Quertz:DraggingEnabled(MainHeader, Main)
    ...
    function Quertz:ChangeColor(prope,color)
