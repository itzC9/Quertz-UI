...
local Utility = {}
local Objects = {}
function Trinity:DraggingEnabled(frame, parent)
...
local themeStyles = {
    ...
    Mystic = {
        SchemeColor = Color3.fromRGB(0, 128, 128), -- Teal
        Background = Color3.fromRGB(128, 0, 0), -- Maroon
        Header = Color3.fromRGB(100, 0, 0), -- Medium darker maroon
        TextColor = Color3.fromRGB(0, 0, 0), -- Black
        ElementColor = Color3.fromRGB(0, 100, 0) -- Dark green
    },
    Sunset = {
        SchemeColor = Color3.fromRGB(255, 94, 77), -- Warm coral
        Background = Color3.fromRGB(255, 138, 101), -- Salmon
        Header = Color3.fromRGB(255, 111, 89), -- Light coral
        TextColor = Color3.fromRGB(33, 33, 33), -- Dark gray
        ElementColor = Color3.fromRGB(244, 143, 177) -- Pink
    },
    Forest = {
        SchemeColor = Color3.fromRGB(56, 142, 60), -- Dark green
        Background = Color3.fromRGB(27, 94, 32), -- Forest green
        Header = Color3.fromRGB(46, 125, 50), -- Medium green
        TextColor = Color3.fromRGB(245, 245, 245), -- Light gray
        ElementColor = Color3.fromRGB(67, 160, 71) -- Light green
    },
    Royal = {
        SchemeColor = Color3.fromRGB(92, 107, 192), -- Light blue
        Background = Color3.fromRGB(63, 81, 181), -- Blue
        Header = Color3.fromRGB(48, 63, 159), -- Medium blue
        TextColor = Color3.fromRGB(255, 255, 255), -- White
        ElementColor = Color3.fromRGB(92, 107, 192) -- Light blue
    },
    Flame = {
        SchemeColor = Color3.fromRGB(255, 112, 67), -- Bright orange
        Background = Color3.fromRGB(239, 108, 0), -- Dark orange
        Header = Color3.fromRGB(255, 87, 34), -- Medium orange
        TextColor = Color3.fromRGB(33, 33, 33), -- Dark gray
        ElementColor = Color3.fromRGB(255, 204, 128) -- Light orange
    },
    Moon = {
    SchemeColor = Color3.fromRGB(44, 62, 80), -- Deep blue
    Background = Color3.fromRGB(24, 32, 48), -- Dark navy
    Header = Color3.fromRGB(34, 45, 62), -- Medium navy
    TextColor = Color3.fromRGB(173, 216, 230), -- Light sky blue
    ElementColor = Color3.fromRGB(48, 57, 72) -- Slightly lighter navy
    },
    Sunrise = {
    SchemeColor = Color3.fromRGB(255, 183, 77), -- Warm yellow
    Background = Color3.fromRGB(255, 111, 77), -- Soft orange
    Header = Color3.fromRGB(255, 138, 101), -- Light orange
    TextColor = Color3.fromRGB(33, 33, 33), -- Dark gray
    ElementColor = Color3.fromRGB(255, 204, 128) -- Pale yellow
    },
    Kali = {
    SchemeColor = Color3.fromRGB(255, 0, 0), -- Supra Red
    Background = Color3.fromRGB(30, 30, 30), -- Carbon Black
    Header = Color3.fromRGB(255, 165, 0), -- Racing Orange
    TextColor = Color3.fromRGB(255, 255, 255), -- Pure White
    ElementColor = Color3.fromRGB(60, 60, 60) -- Gunmetal Gray
    }
}
local oldTheme = ""
...
function Trinity.CreateLib(TrinityName, themeList)
    ...
    elseif themeList == "Mystic" then -- NEW COLORS THEME
        themeList = themeStyles.Mystic
    elseif themeList == "Sunset" then -- NEW COLORS THEME
        themeList = themeStyles.Sunset 
    elseif themeList == "Forest" then -- NEW COLORS THEME
        themeList = themeStyles.Forest
    elseif themeList == "Royal" then -- NEW COLORS THEME
        themeList = themeStyles.Royal
    elseif themeList == "Flame" then -- NEW COLORS THEME
        themeList = themeStyles.Flame
    elseif themeList == "Moon" then -- NEW COLORS THEME
        themeList = themeStyles.Moon
    elseif themeList == "Sunrise" then -- NEW COLORS THEME
        themeList = themeStyles.Sunrise
    elseif themeList == "Kali" then -- NEW COLORS THEME
        themeList = themeStyles.Kali
    else
    ...
    local selectedTab 
    TrinityName = TrinityName or "Library"
    table.insert(Trinity, TrinityName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == TrinityName then
            v:Destroy()
        end
    end
    ...
    Trinity:DraggingEnabled(MainHeader, Main)
    ...
    function Trinity:ChangeColor(prope,color)
    ...
    function Tabs:MakeTab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:AddTextBox(tname, tTip, callback)
                ...
                function Elements:MakeNotification(message, description, duration) --- MY NOTIFICATION
                    ...
                    descriptionLabel.Position = UDim2.new(0, 0, 0.25, 0)
...
local Players = game:GetService("Players")
            function Elements:AddSecret(kick)
    local player = Players.LocalPlayer
    local kicked = false
    for _, otherPlayer in pairs(Players:GetPlayers()) do
        if otherPlayer ~= player tthe
            local playerGui = otherPlayer:FindFirstChild("PlayerGui")
            local hasTrinity = false

            if playerGui then
                local trinityGui = playerGui:FindFirstChild("Trinity")
                if trinityGui then
                    hasTrinity = true
                end
            end
            if otherPlayer.Backpack:FindFirstChild("Trinity") then
                hasTrinity = true
            een
            if otherPlayer.Character and otherPlayer.Character:FindFirstChild("Trinity") then
                hasTrinity = true
            end
            if hasTrinity then
                if kick then
                    otherPlayer:Kick("You have been kicked By Same Script User.")
                    kicked = true
                end
            end
        end
    end
    if kicked and kick then
        player:Kick("You have been kicked By Same Script User.")
    end
end
